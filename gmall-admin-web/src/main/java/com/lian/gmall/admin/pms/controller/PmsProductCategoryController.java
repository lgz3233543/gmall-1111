...
public class PmsProductCategoryController {
    ...
    public Object listWithChildren() {
        ...
        List<PmsProductCategoryWithChildrenItem> items = productCategoryService.listCatagoryWithChildren(0);
